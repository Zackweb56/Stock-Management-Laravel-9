        ...
        <div class="row">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h2 class="text-secondary">Edit Slider Page</h2>
                ...
                <div class="card-body w-100">
                    <form action="{{ route('sliders.store') }}" method="POST" enctype="multipart/form-data" class="d-flex w-100 flex-wrap">
                        ...
                        <div class="form-group col-lg-12 mt-2">
                            ...
                            <input type="text" value="{{ $sliders->title }}" class="form-control @error('title') border-danger @enderror" name="title" id="title" placeholder="enter slider title">
                            @error('title')
                        ...
                        <div class="form-group mt-2 col-12">
                            <img src="/images/{{ $sliders->image }}" width="58px" height="45px" alt="img">
                        </div>
                        <div class="form-group mt-2">
                            <label class="fs-4">Status <span class="text-danger">*</span></label><br>
                            <input type="checkbox" value="{{ $sliders->status }}" class="form-check-input" style="width: 20px;height: 20px;" name="status">&nbsp; Checked=Hidden,Unchecked=Visible
                        </div>
